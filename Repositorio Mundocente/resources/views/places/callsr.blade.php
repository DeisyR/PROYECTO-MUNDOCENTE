...
@section('content')
    ...
    <form method="post" action="{{url('addcallsr')}}" class="form-horizontal">
        {{ csrf_field() }}
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-md-offset-2">
                <img class="img-responsive" src="img\logos\Convocatorias.png" title="Convocatorias">
            </div>
        </div>
