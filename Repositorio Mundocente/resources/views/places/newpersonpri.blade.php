...
<form method="post" action="{{url('createuser')}}" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-md-3">
            <div class="radio">
                <label>
                    <input type="radio" id="docen" name="tipoP" onClick="this.form['listentib'].value='El docente no necesita entidad n_n '; document.getElementById('listentib').disabled = true; document.getElementById('thelist').disabled = true;" value="Docente"> Docente &nbsp;&nbsp;&nbsp;
                </label>
            </div>
            <div class="radio">
                <label>
                    <input type="radio" id="renti" name="tipoP" onClick="this.form['listentib'].value='Seleccione abajo la entidad a la que pertenece'; document.getElementById('listentib').disabled = false; document.getElementById('thelist').disabled = false;" value="Representante" checked> Representante de entidad<br>
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input id="listentib" name="listentib" type="text" placeholder="Seleccione abajo la entidad a la que pertenece" class="form-control input-md"><br>
            <select name="thelist" id="thelist" onChange="combo(this, 'listentib')" onMouseOut="comboInit(this, 'listentib')" >
                <option value="0">Entidades</option>
                @foreach($listentities as $entity)
                <option value="{{$entity->id_entity}}">{{$entity->name_entity}}-{{$entity->name_place}}</option>
                @endforeach
            </select>
                ...
                <li><a href="#">Areas</a>
                    <ul>
                        ...
                        @foreach($listareas as $area)
                            <input type="checkbox" name="animal" value="{{$area->id_area}}" />{{$area->name_area}} <br />
                        @endforeach
                        <br>
                    </ul>
                </li>
    ...
    <!-- Text licen-->
    <div class="form-group">
        <label class="col-md-2 control-label" for="Createcount"></label>
        <div class="col-md-4">
            <p>
                Al hacer clic en Crear Cuenta, aceptas las Condiciones de uso y la Política de privacidad de Mundocente.
            </p>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-6 col-md-offset-2">
            <button id="Createcount" name="Crear Cuenta" class="btn btn-primary"  onClick="f();">Crear Cuenta</button>
        </div>
    </div>
