    ...
    <main>
        ...
        <section id="content1">
            @foreach($listevents as $event)
                <form method="post" action="{{url('edit',[$event->id_publication])}}" class="form-horizontal">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <h4 class="text-center">
                                    <button id="Createcount" name="guardar" class="btn btn-primary"  onClick="f();">Editar</button>
                                </h4>
        ...
        <section id="content2">
            @foreach($listcalls as $call)
                <form method="post" action="{{url('edit',[$call->id_publication])}}" class="form-horizontal">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="full col-md-13 col-md-offset">
        ...
        <section id="content3">
            @foreach($listjournals as $journals)
                <form method="post" action="{{url('edit',[$journals->id_publication])}}" class="form-horizontal">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="full col-md-13 col-md-offset">
